 ...
 *
 */
@Component("baseWebResponseExceptionTranslator")
public class BaseOAuth2WebResponseExceptionTranslator implements WebResponseExceptionTranslator<OAuth2Exception> {
